...
if __name__ == '__main__':
	...
	vgg11_2.load_state_dict(torch.load('Balanced_epoch[18]_learning_rate[0.0000]_vgg_2.pth'))
	...
	# 			patch_path = os.path.join(args.patch_folder_path,folder_name[m])
